...
public class mdAndCodeTOConsoleTool {
    ...
    public static void main(String[] args) throws Exception {
        /*ConnectionSource source = ConnectionSourceHelper.getSimple(JDBCConfiguration.DRIVER, JDBCConfiguration.URL, JDBCConfiguration.USERNAME, JDBCConfiguration.PASSWORD);
